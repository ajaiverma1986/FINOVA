...
namespace FINOVA.Repository
{
    public class UsersRepository : BaseRepository
    {
        ...
        public async Task<UsersDetailsResponse> CheckAvailbleLimit(IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<PartnerLimitResponse> CheckPartnerAvailbleLimit(IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> UpdateUserLogo(UploadLogoRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<OriginatorListAccountResponse>> GetallOriginatorsAccount(IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<OriginatorListAccountResponse>> ListAllOriginatorsAccounts(OriginatorListAccountRequest request, IFINOVAServiceUser serviceUser)
        {
            List<OriginatorListAccountResponse> response = new List<OriginatorListAccountResponse>();
        ...
        public async Task<long> CreateOrgAPIPartner(CreateNewPartnerRequest request, string Password, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<UserAddressListResponse>> GetAllUserAddress(IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> AddUserDeatilKYC(CreateUserDetailKyc request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<UserKYYCResponse>> GetAllUserKyc(IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<UserKYYCResponse>> GetAllUserKycByUserId(long UserId, IFINOVAServiceUser serviceUser)
        {
            List<UserKYYCResponse> response = new List<UserKYYCResponse>();
        ...
        public async Task<long> CreateNewUser(CreateNewUserRequest request, string Password, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> UploadUserKYC(UploadUserKYCRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<UserrKYCListResponse>> ListKYCByUser(IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<UserKYYCResponse>> GetAllUserKycById(long KycId, IFINOVAServiceUser serviceUser)
        {
            List<UserKYYCResponse> response = new List<UserKYYCResponse>();
        ...
        public async Task<long> UpdateOriginatorChequeFile(PayinAccountRegistrationChequeRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<PartnerDeatilsResponse> GetAllUserDeatilsForAdmin(long UserId, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<PartnerDeatilsResponse> GetAllUserDeatils(IFINOVAServiceUser serviceUser)
        {
            PartnerDeatilsResponse response = new PartnerDeatilsResponse();
        ...
        public async Task<List<OriginatorListAccountResponse>> ListAllOriginatorsAccountsforAdmin(OriginatorListAccountforadminRequest request, IFINOVAServiceUser serviceUser)
        {
            List<OriginatorListAccountResponse> response = new List<OriginatorListAccountResponse>();
        ...
        public async Task<long> ApproveRejectOriginatorAccounts(ApproveRejectOriAccountRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<List<UserConfigrationResponse>> GetAllUserConfigration(long UserId, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> UpDateUserConfigrationDetails(UserConfigrationRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> ActivateDeactivateApiUser(ActivateAPIUserRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> ActivateDeactivateUserMaster(ActivateAPIUserMasterRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> ChangePassword(ChangePasswordRequest request, string changepassword, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> AddIPAddress(AddIPAddressRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<SimpleResponse> GetallIPAddress(long UserId, IFINOVAServiceUser serviceUser)
        {
            SimpleResponse response1 = new SimpleResponse();
        ...
        public async Task<long> ApproveRejectIP(ApproveRejectIPAddressRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> AddUserOtherDetail(AddUserOtherDetailRequest request, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<long> AddNewOutLet(CreateNewOutLetRequest request, string passwordd, IFINOVAServiceUser serviceUser)
        {
            long outputstr = 0;
