...
namespace FINOVA.API.Security
{
    public class AuthenticationHelper
    {
        ...
        private async Task<ErrorResponse> Validate(IFINOVAServiceUser serviceUser, bool validateBothToken = true, bool slidingExpiration = true)
        {
        ...
        public async Task<ErrorResponse> AuthenticateAndAuthorize(IFINOVAServiceUser serviceUser, bool validateBothToken = true, bool slidingExpiration = true, Permissions accessType = Permissions.NONE)
        {
            ErrorResponse error = await IsValidToken(serviceUser, validateBothToken, slidingExpiration);
            if (error.HasError)
            {
        ...
        private async Task<ErrorResponse> IsValidToken(IFINOVAServiceUser serviceUser, bool validateBothToken = true, bool slidingExpiration = true)
        {
