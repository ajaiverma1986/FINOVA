...
{
    public interface IFINOVADatabase
    {
        ...
        void AutoGenerateInputParams<T>(SqlCommand cmd, T request, IFINOVAServiceUser FIAAPIUser, bool IsListRequest = false, bool IsAddEditRequest = false, bool IsIncludeApplicationID = false, bool IsIncludeOrganizationID = false);
