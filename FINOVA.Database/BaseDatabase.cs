...
{
    public abstract class BaseDatabase : IFINOVADatabase
    {
        ...
        public void AutoGenerateInputParams<T>(SqlCommand cmd, T request, IFINOVAServiceUser FINOVAAPIUser, bool IsListRequest = false, bool IsAddEditRequest = false, bool IsIncludeApplicationID = false, bool IsIncludeOrganizationID = false)
        {
            string s = "";
            ...
            AddInParameter(cmd, "@LoggedInUserMasterID", FINOVAAPIUser.UserMasterID);
            ...
            {
                AddInParameter(cmd, "@ApplicationID", FINOVAAPIUser.ApplicationID);
            }

            if (IsIncludeOrganizationID)
            {
                AddInParameter(cmd, "@OrganizationID", FINOVAAPIUser.OrganizationID);
                AddInParameter(cmd, "@WorkOrganizationID", FINOVAAPIUser.WorkOrganizationID);
            }
        }
