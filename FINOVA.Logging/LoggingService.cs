...
namespace FINOVA.Logging
{
    public class LoggingService : ILoggingService
    {
        ...
        public async Task LogMessage(string message, IFINOVAServiceUser serviceUser, object moreInfo = null)
        {
            await LogMessage(message, serviceUser, string.Empty, string.Empty, moreInfo);
        }

        public async Task LogMessage(string message, IFINOVAServiceUser serviceUser, string moduleName, string title, object moreInfo = null)
        {
            Log log = new Log();
            log.Message = message;
        ...
        public async Task LogWarning(List<ErrorResponse> errors, IFINOVAServiceUser serviceUser, object moreInfo = null)
        {
            await LogWarning(errors, serviceUser, string.Empty, string.Empty, moreInfo);
        }

        public async Task LogWarning(List<ErrorResponse> errors, IFINOVAServiceUser serviceUser, string moduleName, string title, object moreInfo = null)
        {
            Log log = new Log();
            await InitializeLog(serviceUser, log);
            await InitializeWarningLog(errors, log);
        ...
        public async Task LogWarning(ErrorResponse error, IFINOVAServiceUser serviceUser, object moreInfo = null)
        {
            await LogWarning(error, serviceUser, string.Empty, string.Empty, moreInfo);
        }

        public async Task LogWarning(ErrorResponse error, IFINOVAServiceUser serviceUser, string moduleName, string title, object moreInfo = null)
        {
        ...
        public async Task LogError(Exception exception, object loggerClass, IFINOVAServiceUser serviceUser, object moreInfo = null)
        {
            Log log = new Log();
            await InitializeLog(serviceUser, log);
            await InitializeErrorLog(exception, log);
        ...
        private async Task InitializeLog(IFINOVAServiceUser serviceUser, Log log)
        {
            if (serviceUser != null)
            {
        ...
        private static void InitializeConfigurations()
        {
            ...
            try
            {
                ...
                if (dbTarget != null)
                    dbTarget.ConnectionString = FINOVAApplicationConfiguration.Instance.LoggingDB;
