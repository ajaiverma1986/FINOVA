...
namespace FINOVA.Provider
{
    public class AuthenticationProvider
    {
        ...
        public async Task<UserLoginResponse> Login(UserLoginRequest userLoginRequest, IFINOVAServiceUser serviceUser)
        {
        ...
        private async Task<UserDetails> GetUserLoginDetails(UserLoginRequest userLoginRequest, IFINOVAServiceUser serviceUser)
        {
        ...
        public async Task<bool> IsValidTokenCheck(String apiToken, String userToken, Boolean validateBothToken, Boolean slidingExpiration, IFINOVAServiceUser serviceUser)
        {
            return await _repository.IsValidToken(apiToken, userToken, validateBothToken, slidingExpiration);
        }

        private string GenerateToken(IFINOVAServiceUser request)
        {
            String guid = Guid.NewGuid().ToString();
            return BCrypt.Net.BCrypt.HashString(guid);
        }

        public async Task<SimpleResponse> ForgotPassword(string userName, IFINOVAServiceUser serviceUser)
        {
            SimpleResponse response = new SimpleResponse();
            //SendEmail();
        ...
        public async Task<SimpleResponse> ResetPassword(ResetPasswordRequest request, IFINOVAServiceUser serviceUser)
        {
            SimpleResponse response = new SimpleResponse();
            //TODO: Do all the work and send email notification for password reset.
            return response;
